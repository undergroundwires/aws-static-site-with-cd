...
1. Deploy infrastructure
   ...
   3. Deploy `certificate-stack.yaml`
      ...
      - Watch the status [here](https://console.aws.amazon.com/acm/)
...
- Add IAM secret ID + key, using console:
  1. Go to [IAM users](https://console.aws.amazon.com/iam)
...
- ❗ [Configure your domain registrar](#configure-your-domain-registrar).
  ...
  - 💡 You can watch certificate status on [ACM](https://console.aws.amazon.com/acm/) after configuring your registrar.
...
- If your domain registrar is not registered in Route 53
  - 🚶 Go to your domain registrar and change name servers to NS values
    ...
    - Or you can find those in [Route53](https://console.aws.amazon.com/route53/hosted-zones)
...
- ❗ It [must](https://repost.aws/knowledge-center/cloudfront-invalid-viewer-certificate) be deployed in `us-east-1` to be able to be used by CloudFront by `web-stack`.
...
- ❗ All scripts require: [AWS CLI v2](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
...
- [https://privacy.sexy](https://privacy.sexy) | [repository](https://github.com/undergroundwires/privacy.sexy) | [github actions workflow](https://github.com/undergroundwires/privacy.sexy/blob/master/.github/workflows/release.site.yaml)
- [https://privacylearn.com](https://privacylearn.com)
