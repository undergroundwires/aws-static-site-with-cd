...
- Parameters:
  ...
  - **`UseIndexHtmlRewrite`**
    ...
    - **Description :**
      ...
      - 💡 Useful for static site generators such as **Hugo** or **Docusaurus** with `trailingSlash: true` config.
  - **UsePathHtmlRewrite**
    - **Allowed Values :** `true`, `false`
    - **Default Value :**  `true`
    - **Description :**
      ...
      - 💡 Useful for static site generators such as **Hugo** or **Docusaurus** with `trailingSlash: false` config.
