...
echo Syncing folder to S3
 # For a path that includes the * wildcard, you must use quotes (") around the path. https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Invalidation.html
